...
### 架构讨论流程
1. 先出**设计图**（ASCII 流程图/架构图），确认后再写代码
2. 按模块逐个实现，每个模块独立可测试
3. 先写设计文档到 `docs/architecture/`（入口：`overview.md`），再写代码
4. 不允许硬编码课程内容、岗位数据、面试题目 — 全部从 `resources/` 目录读取
5. 及时更新 CLAUDE.md 和 README.md 保持文档一致性
